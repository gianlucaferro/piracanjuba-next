...
export default function EmailChangeEmail({ confirmationUrl, newEmail }: EmailChangeProps) {
  return (
    <Html>
      <Head />
      <Body style={main}>
        <Container style={container}>
          <Section style={section}>
            <Text style={heading}>Confirmar alteração de email</Text>
            <Text style={paragraph}>
              Recebemos uma solicitação para alterar o email da sua conta no Piracanjuba.Ai
