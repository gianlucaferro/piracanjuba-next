# Fotos das pessoas notórias (História PBA)

Coloque aqui as fotos dos "Filhos ilustres" da página /historia-pba.
O componente `PessoaFoto` carrega automaticamente o arquivo abaixo; se não existir,
mostra as iniciais. Use JPG, de preferência quadrado (ex: 400x400).

Arquivos esperados (nome = slug.jpg):

- `leo-lynce.jpg`            -> Leo Lynce (poeta)
