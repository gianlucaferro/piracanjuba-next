...
const ABAS: Record<string, { title: string; description: string }> = {
  ...
  funprepi: { title: "FUNPREPI e previdência municipal de Piracanjuba GO", description: "Despesas, benefícios, contratos, cobertura dos dados e evidências atuariais do Fundo de Previdência Social de Piracanjuba, com fontes oficiais." },
